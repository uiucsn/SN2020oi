...
"""
import os
folderroot = '/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/plot_spectra_2020oi'
os.chdir(folderroot)
import numpy as np
...
w2 = np.genfromtxt('SN2020oi-20200109-goodman.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f2 = np.genfromtxt('SN2020oi-20200109-goodman.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w11 = np.genfromtxt('SN2020oi-20200116-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f11 = np.genfromtxt('SN2020oi-20200116-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w15 = np.genfromtxt('SN2020oi-20200120-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f15 = np.genfromtxt('SN2020oi-20200120-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w17 = np.genfromtxt('SN2020oi-20200122-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f17 = np.genfromtxt('SN2020oi-20200122-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w19 = np.genfromtxt('SN2020oi-20200124-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f19 = np.genfromtxt('SN2020oi-20200124-floyds.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w20 = np.genfromtxt('SN2020oi-20200127-lris.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f20 = np.genfromtxt('SN2020oi-20200127-lris.flm_mangled_ext_cor_total_0.18.flm', usecols=1)
w25 = np.genfromtxt('SN2020oi-20200201-goodman.flm_mangled_ext_cor_total_0.18.flm', usecols=0)
f25 = np.genfromtxt('SN2020oi-20200201-goodman.flm_mangled_ext_cor_total_0.18.flm', usecols=1)#corrected for the Angstrom
w37 = np.genfromtxt('spectrum_2020_02_13.txt', usecols=0)
f37 = np.genfromtxt('spectrum_2020_02_13.txt', usecols=1)


#SN2020oi_floyds_20200116_norm_no_ext_cor.csv

#SN2020oi_lris_20200127_norm_ext_cor_total_0_133.csv
#SN2020oi_floyds_20200201_norm_ext_cor_total_0_133.csv
#SN2020oi_lris_20200216_norm_ext_cor_total_0_133.csv

w11_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200116_norm_ext_cor_total_0_133.csv', usecols=0)
f11_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200116_norm_ext_cor_total_0_133.csv', usecols=1)
w15_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200120_norm_ext_cor_total_0_133.csv', usecols=0)
f15_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200120_norm_ext_cor_total_0_133.csv', usecols=1)
w17_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200122_norm_ext_cor_total_0_133.csv', usecols=0)
f17_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200122_norm_ext_cor_total_0_133.csv', usecols=1)
w19_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200124_norm_ext_cor_total_0_133.csv', usecols=0)
f19_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200124_norm_ext_cor_total_0_133.csv', usecols=1)
w20_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_lris_20200127_norm_ext_cor_total_0_133.csv', usecols=0)
f20_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_lris_20200127_norm_ext_cor_total_0_133.csv', usecols=1)
w23_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200131_norm_ext_cor_total_0_133.csv', usecols=0)
f23_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_floyds_20200131_norm_ext_cor_total_0_133.csv', usecols=1)
w25_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_goodman_20200201_norm_ext_cor_total_0_133.csv', usecols=0)
f25_new = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/spectra/all_20oi_spectra_final/csv/SN2020oi_goodman_20200201_norm_ext_cor_total_0_133.csv', usecols=1)
...
l2_new = 4*np.pi*(d**2)*(f2)
l11_new = 4*np.pi*(d**2)*(f11_new)
l15_new = 4*np.pi*(d**2)*(f15_new)
l17_new = 4*np.pi*(d**2)*(f17_new)
l19_new = 4*np.pi*(d**2)*(f19_new)
l20_new = 4*np.pi*(d**2)*(f20_new)
l25_new = 4*np.pi*(d**2)*(f25)
l37_new = 4*np.pi*(d**2)*(f37)

#smooth day 9 spectrum
l11 = convolve(l11, Box1DKernel(5))
l11_new = convolve(l11_new, Box1DKernel(5))
...
def plot_tardis():
    ...
    wsim_day11 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day10_final.txt', usecols=0, skip_header=0)
    fsim_day11 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day10_final.txt', usecols=1, skip_header=0)

    wsim_day15 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day14_final.txt', usecols=0, skip_header=0)
    fsim_day15 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day14_final.txt', usecols=1, skip_header=0)

    wsim_day17 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day16_final.txt', usecols=0, skip_header=0)
    fsim_day17 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day16_final.txt', usecols=1, skip_header=0)

    wsim_day19 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day18_final.txt', usecols=0, skip_header=0)
    fsim_day19 = np.genfromtxt('/Users/alexgagliano/Documents/Research/2020oi/data/derived_data/finalSims_SNpeak/SN2020oi_sim_spec_Day18_final.txt', usecols=1, skip_header=0)
...
#    sns.set(font_scale=)
    ...
    #plt.title('SN2020oi spectral sequence', fontsize=17)
    #plt.plot(w2,l2+1.55E39,'k',label='Day 2')
    plt.plot(w11_new/1.005,(l11_new + 1.15E39),'k',lw=2, zorder=100)
    plt.plot(w15_new/1.005,(l15_new + 0.65E39),'k',lw=2, zorder=100)
    plt.plot(w17_new/1.005,(l17_new + 0.25E39),'k',lw=2, zorder=100)
    plt.plot(w19_new/1.005,(l19_new),'k',lw=2, zorder=100)
    #plot TARDIS
...
#    plt.legend(fontsize=14)
    ...
    plt.savefig('/Users/alexgagliano/Documents/Research/2020oi/img/SN2020oi_TARDIS_1994I_rereduced.png',dpi=200, bbox_inches='tight')
plot_tardis()
